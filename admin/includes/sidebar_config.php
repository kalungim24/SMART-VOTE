 ...
 * Easy management of admin sidebar menu items
 */
...
return [
    ...
    'main_menu' => [
        [
            ...
            'is_dashboard' => true, // Special handling for dashboard
        ],
        [
            'title' => 'Manage Voters',
            'url' => 'manage_voters.php',
        ...
        [
            'title' => 'Enhanced Elections',
            'url' => 'enhanced_elections.php',
        ...
        [
            ...
            'url' => 'super_admin.php',
            'icon' => '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path></svg>',
            'badge' => 'ADMIN',
            'roles' => ['super_admin'],
        ],
        // Note: clear_rate_limits.php is a utility page, not typically in main menu
        // If needed, uncomment below to add it
        // [
        //     'title' => 'Clear Rate Limits',
        //     'url' => 'clear_rate_limits.php',
    ...
    // Settings Section (shown after divider)
    'settings_menu' => [
        [
    ...
    'brand' => [
        'title' => get_system_name($pdo) . ' Admin',
    ...
    'logout' => [
        ...
        'style' => 'danger', // danger, warning, info, default
    ],
];
